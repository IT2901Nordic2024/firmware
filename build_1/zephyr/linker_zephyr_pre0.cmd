...
MEMORY
    ...
    RAM (wx) : ORIGIN = 0x20010568, LENGTH = 0x2fa98
...
conn_mgr_conn_binding_area : ALIGN_WITH_INPUT SUBALIGN(4) { _conn_mgr_conn_binding_list_start = .; KEEP(*(SORT_BY_NAME(._conn_mgr_conn_binding.static.*))); _conn_mgr_conn_binding_list_end = .; } > RAM AT > FLASH
    __data_region_end = .;
 ...
 *(".kernel_noinit.*")
    ...
    __kernel_ram_end = 0x20010568 + 0x2fa98;
